...
export default function DiaryArea({setMode, playList, setPlaylist}) {
    ...
    const onTemplateUpload = (event) => {
        ...
        const response = xhr.response; // Assuming the server returns JSON
    ...
    return (
        <div>
            ...
            <FileUpload ref={fileUploadRef} name="demo[]" url="http://127.0.0.1:5000/playlist" multiple accept="text/*" maxFileSize={1000000}
